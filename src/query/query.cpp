...
Json::Value LEAGUE_V4::challenger(const std::string& routing, const std::string& queue) {
...
Json::Value LEAGUE_V4::grandmaster(const std::string& routing, const std::string& queue) {
...
Json::Value LEAGUE_V4::master(const std::string& routing, const std::string& queue) {
...
Json::Value LEAGUE_V4::by_summoner_id(const std::string& routing, const std::string& summoner_id) {
...
Json::Value LEAGUE_V4::by_league_id(const std::string& routing, const std::string& league_id) {
...
Json::Value LEAGUE_V4::specific_league(const_str_r routing, const_str_r queue, const_str_r tier, const_str_r division, const std::pair<std::string, int>& page) {
...
Json::Value VAL_CONTENT_V1::content(const std::string& routing, const std::pair<std::string, std::string>& locale) {
...
Json::Value VAL_RANKED_V1::by_act(const_str_r routing, const_str_r actId, const std::pair<std::string, std::string>& locale) {
